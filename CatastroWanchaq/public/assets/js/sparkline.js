  ...
  var mdraw = function() {
      ...
      if (lastmousetime && lastmousetime!=timenow) {
          ...
          if (mpoints.length > mpoints_max)
              mpoints.splice(0,1);
          mousetravel = 0;
          $('#mouseSpeedChart').sparkline(mpoints, { width: mpoints.length*2, tooltipSuffix: ' pixels per second', lineColor: 'rgb(204,153,0)' });
      }
...
$("#sparklinePie").sparkline([1,3,2], {type: 'pie', width: '150', height: '50', sliceColors: ['rgb(255,51,102)', 'rgb(102,209,209)', 'rgb(204,153,0)']});
