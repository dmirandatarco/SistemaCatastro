...
<div class="mb-3">
<label for="message-text" class="form-label">Nro de Registro:</label>
  <input type="text" class="form-control nregistro" id="nregistro"  name="nregistro" value="{{old('nregistro')}}" maxlength="7">
  @error('nregistro')
    <span class="error-message" style="color:red">{{ $message }}</span>
  @enderror
</div>
