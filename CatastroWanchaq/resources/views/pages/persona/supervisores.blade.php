                        ...
                        <table id="manzanas" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('supervisor.edit')
                                        <button type="button" class="btn btn-primary btn-icon edit" data-bs-toggle="modal" data-bs-target="#Editar" data-id="{{$persona->id_persona}}" data-nume_doc="{{$persona->nume_doc}}" data-nombres="{{$persona->nombres}}" data-ape_paterno="{{$persona->ape_paterno}}" data-ape_materno="{{$persona->ape_materno}}">
