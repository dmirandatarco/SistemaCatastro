...
<div class="row inbox-wrapper">
    <div class="col-md-12">
        ...
        <div class="card-body">
            <div class="row">
            <h4 class="mb-3">Crear Ficha Generar Catastral</h4>
            {!!Form::open(array('url'=>'generarcatastral/indexgenerarcatastral','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                    ...
                    <tbody>
                        @foreach($ficha as $ficha)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('ficha.generarcatastralcreate',$ficha) }}">
