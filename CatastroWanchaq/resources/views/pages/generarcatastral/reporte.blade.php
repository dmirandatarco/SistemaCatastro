...
<div class="row inbox-wrapper">
    <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            {!!Form::open(array('url'=>'generarcatastral/reportegenerarcatastral','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
            ...
            <div class="table-responsive ">
                <table class="table">
                    ...
                    <tbody>
                        @foreach($fichasCatastral as $ficha)
                            <tr>
                                <td>{{$ficha->id}}</td>
                                ...
                                <td>
                                    <a href="{{ route('pdf.certificado',$ficha) }}">
